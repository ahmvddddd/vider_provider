...
class PortfolioUploadScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PortfolioUploadScreen> createState() => _PortfolioUploadScreenState();
}
...
class _PortfolioUploadScreenState extends ConsumerState<PortfolioUploadScreen> {
  ...
  void _upload() async {
    ...
    ref.read(portfolioUploadControllerProvider.notifier).uploadImages(context, _selectedImages);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TAppBar(title: Text('Upload Portfolio Images',
        ...
        child: Column(
          ...
          children: [
            const TitleAndDescription(
                    ...
                    description: 'Upload 4 clear images that display the service you provide. Do not uploadother users images as this could lead to suspension of your account',
                  ),
            ...
            if (_selectedImages.isNotEmpty)
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: _selectedImages.map((file) => RoundedContainer(
            ...
            uploadState.when(
              ...
              error: (e, _) => Center(child: Text('An error occured failed to upload portfolio images',
