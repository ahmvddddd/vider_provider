...
// final userLocalProvider = StateNotifierProvider<UserLocalController, AsyncValue<UserProfileModel>>((ref) {
//   return UserLocalController();
// });
//
// class UserLocalController extends StateNotifier<AsyncValue<UserProfileModel>> {
//   UserLocalController() : super(const AsyncLoading());
//
...
//     } else {
//       // No local data found — fetch from API
...
//         state = AsyncData(user);
//       } else {
//         state = AsyncError('Failed to fetch user: ${response.body}', StackTrace.current);
//       }
//     } catch (e, st) {
...
//   await fetchUserDetails(); // always fetch from API
// }
//
// }
